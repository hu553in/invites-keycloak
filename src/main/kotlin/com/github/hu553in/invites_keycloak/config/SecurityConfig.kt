...
@Configuration
@EnableWebSecurity
class SecurityConfig(private val keycloakProps: KeycloakProps) {
    ...
    @Bean
    fun keycloakAuthoritiesMapper(): GrantedAuthoritiesMapper = GrantedAuthoritiesMapper { authorities ->
